...
def get_np():
    ...
    return down_len,up_len,down_up_count,speed,driver,all
...
def get_train_data(down_len,up_len,down_up_count,speed,driver):
    day_0_c0 = []
    day_0_c1 = []
    day_0_c2 = []
    day_0_c3 = []
    ...
    return day_0_c0, day_0_c1, day_0_c2, day_0_c3, day_0_c4, day_1_c0, day_1_c1, day_1_c2, day_1_c3, day_1_c4, day_2_c0, day_2_c1, day_2_c2, day_2_c3, day_2_c4,y


def get_test_data(down_len,up_len,down_up_count,speed,driver):
    day_0_c0 = []
    day_0_c1 = []
    day_0_c2 = []
    day_0_c3 = []
...
def test_data():
    down_len, up_len, down_up_count, speed, driver, all = get_np()
    day_0_c0, day_0_c1, day_0_c2, day_0_c3, day_0_c4, day_1_c0, day_1_c1, day_1_c2, day_1_c3, day_1_c4, day_2_c0, day_2_c1, day_2_c2, day_2_c3, day_2_c4, y = get_test_data(down_len, up_len, down_up_count, speed, driver)
    return day_0_c0, day_0_c1, day_0_c2, day_0_c3, day_0_c4, day_1_c0, day_1_c1, day_1_c2, day_1_c3, day_1_c4, day_2_c0, day_2_c1, day_2_c2, day_2_c3, day_2_c4, y


def train_data():
    down_len, up_len, down_up_count, speed, driver, all = get_np()
    day_0_c0, day_0_c1, day_0_c2, day_0_c3, day_0_c4, day_1_c0, day_1_c1, day_1_c2, day_1_c3, day_1_c4, day_2_c0, day_2_c1, day_2_c2, day_2_c3, day_2_c4 ,y= get_train_data(down_len, up_len, down_up_count, speed, driver)
    return day_0_c0, day_0_c1, day_0_c2, day_0_c3, day_0_c4, day_1_c0, day_1_c1, day_1_c2, day_1_c3, day_1_c4, day_2_c0, day_2_c1, day_2_c2, day_2_c3, day_2_c4 ,y
