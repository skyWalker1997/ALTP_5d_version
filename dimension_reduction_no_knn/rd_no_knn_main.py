...
import numpy as np
from dimension_reduction_no_knn import data_loader
from dimension_reduction_no_knn import models_noknn_reduce_dimension
from dimension_reduction_no_knn import knn_new
...
def test_weight():
    ...
    for i in range(1, 100, 5):
        ...
        for j in range(0, 3):
            ...
            model = models_noknn_reduce_dimension.model()
